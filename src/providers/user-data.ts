...
export class UserData {
    ...
    login(username) {
        Promise.all([this.storage.set(this.HAS_LOGGED_IN, true), this.setUsername(username)])
    ...
    logout() {
        Promise.all([this.storage.remove(this.HAS_LOGGED_IN), this.storage.remove("username")])
