...
export class TransfertService {
    ...
    UploadApply(item, fnc, value) {
        ...
        Promise.all([this.sqlLiteData.update(item), this.notificationService.uploadEndService(value), fnc()])
    ...
    upload(item): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            this.fileService.WriteJsonMeta(metaForZenon)
                .then(jsonUri => {
                    ...
                    Promise.all([
                        ...
                        .then(data => this.uploadFile(exportName, cordova.file.dataDirectory + "fin.txt", "txt", item)
